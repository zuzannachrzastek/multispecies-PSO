...
public class ExecutionParameters {
    ...
    public static final int EXECUTIONS = 20;
    public static final int ITERATIONS = 100;
    public static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy.MM.dd::HH:mm");
    public static final String LABEL = "PSO_STANDARD::" + DATE_FORMAT.format(new Timestamp(System.currentTimeMillis()));
    public static final String LABEL_MODIFIED = "PSO_MODIFIED::" + DATE_FORMAT.format(new Timestamp(System.currentTimeMillis()));
    public static final FitnessFunction FITNESS_FUNCTION = new Rosenbrock();
